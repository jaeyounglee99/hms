...
public class AdminOrderController {
	...
	public void orderExcelExport(HttpServletResponse response , @RequestParam Map<String, String> dateMap) throws Exception {
	    ...
	    Sheet sheet = wb.createSheet("예약리스트");
	    Row row = null;
	    Cell cell = null;
	    ...
	    cell.setCellStyle(headStyle);
	    cell.setCellValue("객실명");
	    cell = row.createCell(3);
	    cell.setCellStyle(headStyle);
	    cell.setCellValue("체크인");
	    cell = row.createCell(4);
	    cell.setCellStyle(headStyle);
	    cell.setCellValue("체크아웃");
	    cell = row.createCell(5);
	    cell.setCellStyle(headStyle);
	    cell.setCellValue("조식추가");
	    cell = row.createCell(6);
	    cell.setCellStyle(headStyle);
	    cell.setCellValue("수영장추가");
		...
		for (Map<String,Object> orderMap :  adminOrderService.getOrderList()) {
	        ...
	        cell = row.createCell(2);
	        cell.setCellStyle(bodyStyle);
	        cell.setCellValue((String)orderMap.get("roomsNm"));
	        cell = row.createCell(3);
	        cell.setCellStyle(bodyStyle);
	        cell.setCellValue((String)orderMap.get("checkIn"));
	        cell = row.createCell(4);
	        cell.setCellStyle(bodyStyle);
	        cell.setCellValue((String)orderMap.get("checkOut"));
	        cell = row.createCell(5);
	        cell.setCellStyle(bodyStyle);
	        cell.setCellValue((Integer)orderMap.get("breakfast"));
	        cell = row.createCell(6);
	        cell.setCellStyle(bodyStyle);
	        cell.setCellValue((Integer)orderMap.get("swimmingPool"));
	        cell = row.createCell(7);
	        cell.setCellStyle(bodyStyle);
