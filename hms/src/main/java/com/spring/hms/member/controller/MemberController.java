package com.spring.hms.member.controller;
...
import com.spring.hms.member.service.MemberService;
...
public class MemberController {
	...
	public ResponseEntity<Object> register(MemberDto memberDto , HttpServletRequest request) {
	...
	public ResponseEntity<String> overlapped(@RequestParam("memberId") String memberId) {
	...
	public ResponseEntity<Object> login(MemberDto memberDto , HttpServletRequest request){
